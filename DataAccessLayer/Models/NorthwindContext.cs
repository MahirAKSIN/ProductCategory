...
namespace DataAccessLayer.Models
{
    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<MusteriMusteriDemo> MusteriMusteriDemos { get; set; }
        ...
        public virtual DbSet<PersonelBolgeler> PersonelBolgelers { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-LOIGVJB;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MusteriMusteriDemo>(entity =>
            {
                ...
                entity.ToTable("MusteriMusteriDemo");
                ...
                entity.HasOne(d => d.Musteri)
                    .WithMany(p => p.MusteriMusteriDemos)
            ...
            modelBuilder.Entity<PersonelBolgeler>(entity =>
            {
                ...
                entity.ToTable("PersonelBolgeler");
                ...
                entity.HasOne(d => d.Personel)
                    .WithMany(p => p.PersonelBolgelers)
